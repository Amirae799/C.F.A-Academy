        ...
        <div class="col-lg-8 col-xl-6">
          <div class="card rounded-3">
            <div class="card-body p-4 p-md-5">
              ...
              <form class="px-md-2" action="{{route('admin.saveTrainer')}}" method="POST">
@csrf
...
@endif
                <div class="form-outline mb-4">
                  ...
                  <input type="text" id="form3Example1q" name="name" placeholder="enter trainer name" class="form-control" />
                  @error('name')
                ...
                <div >
                    ...
                    <input type="phone" id="form3Example1q" name="phone"   placeholder="enter trainer phone" class="form-control" />
                    @error('phone')
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <input type="text" id="form3Example1q" name="deprt" placeholder="enter trainer deprt" class="form-control" />
                    @error('deprt')
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                <div class="form-outline mb-4">
                    ...
                    <input type="text" id="form3Example1q" name="role" placeholder="" class="form-control" />
